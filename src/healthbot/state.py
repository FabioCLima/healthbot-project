...
class HealthBotState(TypedDict):
    ...
    results: str | None
    summary: str | None
    has_results: bool | None        # Whether Tavily search returned results
    sources_count: int | None       # Number of sources found
    run_id: str | None              # Unique identifier for this execution
